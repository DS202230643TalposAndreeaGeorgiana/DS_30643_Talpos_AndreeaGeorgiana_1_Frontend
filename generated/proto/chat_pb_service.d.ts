...
type ChatServiceReceiveMessages = {
  ...
  readonly requestType: typeof proto_chat_pb.ReceiveMessagesRequests;
...
export class ChatServiceClient {
  ...
  receiveMessages(requestMessage: proto_chat_pb.ReceiveMessagesRequests, metadata?: grpc.Metadata): ResponseStream<proto_chat_pb.ChatMessage>;
  sendMessage(
  ...
  ping(
    requestMessage: proto_chat_pb.ChatMessage,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: proto_chat_pb.ChatMessage|null) => void
  ): UnaryResponse;
  ping(
    requestMessage: proto_chat_pb.ChatMessage,
    callback: (error: ServiceError|null, responseMessage: proto_chat_pb.ChatMessage|null) => void
